...
type DockingEvent struct {
	...
	FlightVehicleChaser *SpacecraftFlightNormal
	FlightVehicleTarget *SpacecraftFlightMini
	Id int32
	PayloadFlightChaser *PayloadFlightNormal
	PayloadFlightTarget *PayloadFlightMini
	ResponseMode string
	SpaceStationChaser *SpaceStationNormal
	SpaceStationTarget *SpaceStationMini
	Url string
}
...
type SpacecraftFlightMini struct {
	Destination *string
	Duration string
	Id int32
	Landing *Landing
...
type ListDockingEventsRequest struct {
	Limit  int32
	Offset int32
	Search string
	Mode   string
...
type ListDockingEventsResponse struct {
	Count    int32
	Next     string
	Previous string
...
type GetDockingEventRequest struct {
	ID   int32
	Mode string
}
