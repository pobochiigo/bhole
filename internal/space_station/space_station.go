...
type DockingEventDetailedSerializerForSpacestation struct {
	Departure *string
	Docking string
	FlightVehicleChaser *SpacecraftFlightForDockingEvent
	Id int32
	PayloadFlightChaser *PayloadFlightNormal
	SpaceStationChaser *SpaceStationNormal
	Url string
}
...
type DockingLocationSerializerForSpacestation struct {
	CurrentlyDocked *DockingEventDetailedSerializerForSpacestation
	Id int32
	Name string
}

type ExpeditionMini struct {
	End *string
	Id int32
	Name string
	Start string
...
type SpacecraftFlightForDockingEvent struct {
	Id int32
	Launch *LaunchNormal
...
type ListSpaceStationsRequest struct {
	Limit  int32
	Offset int32
	Search string
	Mode   string
...
type ListSpaceStationsResponse struct {
	Count    int32
	Next     string
	Previous string
...
type GetSpaceStationRequest struct {
	ID   int32
	Mode string
}
