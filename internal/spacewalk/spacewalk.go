...
type ExpeditionNormalSerializerForSpacewalk struct {
	End *string
	Id int32
...
type SpacecraftFlightDetailed struct {
	Destination *string
...
type Spacewalk struct {
	...
	End *string
	Event *EventNormal
	Expedition *ExpeditionNormalSerializerForSpacewalk
	Id int32
	Location *string
	Name string
	Program []ProgramNormal
	ResponseMode string
	SpacecraftFlight *SpacecraftFlightDetailed
	Spacestation *SpaceStationNormal
	Start *string
	Url string
}
...
type ListSpacewalksRequest struct {
	Limit  int32
	Offset int32
	Search string
	Mode   string
...
type ListSpacewalksResponse struct {
	Count    int32
	Next     string
	Previous string
	Results  []Spacewalk
...
type GetSpacewalkRequest struct {
	ID   int32
	Mode string
}
